...
@Entity
public class ForumSecondState extends PhaseState {

    public static final String phaseName = "ForumSecond";

    public Game game;
    public Player player;

    public ForumSecondState(Game game, Player player){
        this.game = game;
        this.player = player;
        super.setName(phaseName);
    }
    public ForumSecondState(){}
